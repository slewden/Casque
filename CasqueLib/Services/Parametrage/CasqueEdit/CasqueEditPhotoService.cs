...
namespace CasqueLib.Services.Parametrage.CasqueEdit
{
  ...
  /// </summary>
  public class CasqueEditPhotoService : FsService
  {
    /// <summary>
    ...
    public object Post(CasqueEditPhotoRequest request)
    {
      ...
      return new CasqueEditPhotoResponse()
      {
        PhotoNom = fileName
      };
    }
    ...
    {
      string fullFileName = Folder.FullPath(Folder.EFolder.Casque, fileName);
